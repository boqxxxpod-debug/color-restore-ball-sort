...
const productionAssets=['css/style.css','data/stages.js','data/advanced-stages.js','data/progression.js','data/flip-stages.js','js/storage.js','js/sound.js','js/game.js','js/hint.js','js/stage.js','js/app.js'];
...
assert(html.includes('<span id="stage-total">65</span>'),'total level count must remain visible in the game header');
