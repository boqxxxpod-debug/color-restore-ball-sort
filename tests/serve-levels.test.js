...
assert(html.includes('id="serve-area"')&&html.includes('data/serve-stages.js?v=20260913-1'),'the queue surface and stage data are loaded');assert(html.includes('<span id="stage-total">80</span>'),'the header announces all 80 levels');
