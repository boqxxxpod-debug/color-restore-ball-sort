...
Runtime state and the audit log are maintained in [automation-control Issue #27](https://github.com/boqxxxpod-debug/color-restore-ball-sort/issues/27).
...
- Infrastructure, dependency, security, authentication, and repository-setting changes are never auto-merged.
